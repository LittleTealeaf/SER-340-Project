...
\begin{itemize}
  ...
  % \item \textbf{REQ-2} An admin can create an instructor account with a username and password
  % \item \textbf{REQ-3} An instructor can create a course with a name and description
  % \item \textbf{REQ-4} An instructor can create a student account for a course with a username and password
  % \item \textbf{REQ-5} An instructor can view a list of their courses
  % \item \textbf{REQ-6} An instructor can view a list of assignments in a course
  % \item \textbf{REQ-7} An instructor can create an assignment
  % \item \textbf{REQ-8} An instructor can view student grades in a course
  % \item \textbf{REQ-9} An instructor can view submissions for an assignment
  % \item \textbf{REQ-10} An instructor can provide feedback to an assignment submission
  % \item \textbf{REQ-11} An instructor can view feedback for an assignment submission
  % \item \textbf{REQ-12} A student can view a list of assignments for their course
  % \item \textbf{REQ-13} An instructor can upload a test case to an assignment
  % \item \textbf{REQ-14} A student can upload their submission code to an assignment
  % \item \textbf{REQ-15} A student can submit an assignment
  % \item \textbf{REQ-16} A student can view the grade on a submission
  % \item \textbf{REQ-17} A
\end{itemize}
...
% \subparagraph{REQ-1} An admin can sign in using a username and password
% \subparagraph{REQ-2} An instructor can sign in using a username and password
% \subparagraph{REQ-3} A student can sign in using a username and password
...
% \subparagraph{REQ-1} An admin, instructor, or student can log in using a username and password
...
% \subparagraph{REQ-2} An admin can create an instructor account and set the username and password
...
% \subparagraph{REQ-3} An instructor can create a student account for one of their courses.
...
% \subparagraph{REQ-4}  An instructor can create a course
...
% \subparagraph{REQ-5} An instructor can create an assignment within a course.
...
% \subparagraph{REQ-17} An instructor can upload a test case with an input text file and an expected output text file.
